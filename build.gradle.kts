...
kotlin {
    ...
    val commonMain by sourceSets.getting {
        dependencies {
            api("fr.acinq.bitcoin:bitcoin-kmp:0.12.0-SNAPSHOT") // when upgrading, keep secp256k1-kmp-jni-jvm in sync below
    ...
    jvm {
        ...
        compilations["main"].defaultSourceSet.dependencies {
            ...
            implementation("fr.acinq.secp256k1:secp256k1-kmp-jni-jvm:0.10.0-SNAPSHOT")
