 ...
 */
fun didCompleteWalletPayment(id: WalletPaymentId, database: PaymentsDatabase) {}
 ...
 * with respect to the referenced row.
 */
fun didUpdateWalletPaymentMetadata(id: WalletPaymentId, database: PaymentsDatabase) {}

/**
 * Implemented on Apple platforms with support for CloudKit.
 */
fun makeCloudKitDb(database: PaymentsDatabase): CloudKitInterface? { return null }