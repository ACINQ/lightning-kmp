...
open class SpliceTestsCommon : LightningTestSuite() {
    open val defaultChannelType: ChannelType.SupportedChannelType = ChannelType.SupportedChannelType.SimpleTaprootStaging // ChannelType.SupportedChannelType.AnchorOutputs
