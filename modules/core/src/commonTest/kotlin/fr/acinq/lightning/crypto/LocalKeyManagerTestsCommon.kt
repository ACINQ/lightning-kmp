...
class LocalKeyManagerTestsCommon : LightningTestSuite() {
    ...
    fun `generate channel keys`() {
        ...
        assertEquals(PrivateKey.fromHex("ad635d9d4919e5657a9f306963a5976b533e9d70c8defa454f1bd958fae316c8"), channelKeys.paymentBaseSecret, errorMsg)
        assertEquals(PrivateKey.fromHex("0f3c23df3feec614117de23d0b3f014174271826a16e59a17d9ebb655cc55e3f"), channelKeys.delayedPaymentBaseSecret, errorMsg)
        assertEquals(PrivateKey.fromHex("ee211f583f3b1b1fb10dca7c82708d985fde641e83e28080f669eb496de85113"), channelKeys.revocationBaseSecret, errorMsg)
    ...
    fun `generate different node ids from the same seed on different chains`() {
        ...
        assertNotEquals(channelKeys1.fundingKey(0).publicKey(), channelKeys2.fundingKey(0).publicKey())
    ...
    fun `test vectors -- testnet + initiator`() {
        ...
        assertEquals(channelKeys.fundingKey(0).publicKey(), PrivateKey.fromHex("730c0f99408dbfbff00146acf84183ce539fabeeb22c143212f459d71374f715").publicKey())
    ...
    fun `test vectors -- testnet + non-initiator`() {
        ...
        assertEquals(channelKeys.fundingKey(0).publicKey(), PrivateKey.fromHex("cd85f39fad742e5c742eeab16f5f1acaa9d9c48977767c7daa4708a47b7222ec").publicKey())
    ...
    fun `test vectors -- mainnet + initiator`() {
        ...
        assertEquals(channelKeys.fundingKey(0).publicKey(), PrivateKey.fromHex("b3b3f1af2ef961ee7aa62451a93a1fd57ea126c81008e5d95ced822cca30da6e").publicKey())
    ...
    fun `test vectors -- mainnet + non-initiator`() {
        ...
        assertEquals(channelKeys.fundingKey(0).publicKey(), PrivateKey.fromHex("033880995016c275e725da625e4a78ea8c3215ab8ea54145fa3124bbb2e4a3d4").publicKey())
    ...
    fun `compute descriptors to recover swap-in funds`() {
        ...
        val userRefundExtendedPrivateKey = master.derivePrivateKey(SwapInOnChainKeys.swapInUserRefundKeyPath(chain))
