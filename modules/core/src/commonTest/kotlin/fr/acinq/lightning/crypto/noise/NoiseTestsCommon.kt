...
class NoiseTestsCommon : LightningTestSuite() {
    @Test
    fun `hash tests`() {
        ...
        assertContentEquals(a, Hex.decode("f6f78327c10316fdad06633fb965e03182e9a8b1f755d613f7980fbb85ebf46d"))
        assertContentEquals(b, Hex.decode("4ee4220f31dbd3c9e2367e66a87f1e98a2433e4b9fbecfd986d156dcf027b937"))
    }
    ...
    fun `Noise_XK_secp256k1_ChaChaPoly_SHA256 test vectors`() {
        ...
        assertContentEquals(enc.k, Hex.decode("969ab31b4d288cedf6218839b27a3e2140827047f2c0f01bf5c04435d43511a9"))
        assertContentEquals(dec.k, Hex.decode("bb9020b8965f4df047e07f955f3c4b88418984aadc5cdb35096b9ea8fa5c3442"))
        ...
        assertContentEquals(outputs[0], Hex.decode("036360e856310ce5d294e8be33fc807077dc56ac80d95d9cd4ddbd21325eff73f70df6086551151f58b8afe6c195782c6a"))
        assertContentEquals(outputs[1], Hex.decode("02466d7fcae563e5cb09a0d1870bb580344804617879a14949cf22285f1bae3f276e2470b93aac583c9ef6eafca3f730ae"))
        assertContentEquals(outputs[2], Hex.decode("b9e3a702e93e3a9948c2ed6e5fd7590a6e1c3a0344cfc9d5b57357049aa22355361aa02e55a8fc28fef5bd6d71ad0c38228dc68b1c466263b47fdf31e560e139ba"))
        assertContentEquals(ciphertext01, Hex.decode("b64b348cbb37c88e5b76af12dce00a4a69cbe224a374aad16a4ab1b93741c4"))
        assertContentEquals(ciphertext02, Hex.decode("289de201e633a43e01ea5b0ec1df9726bd04d0109f530f7172efa5808c3108"))
    }
