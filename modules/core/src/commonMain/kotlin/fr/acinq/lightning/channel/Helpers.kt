    ...
    object Closing {
        ...
        object LocalClose {
            ...
            fun LoggingContext.claimHtlcDelayedOutputs(localCommitPublished: LocalCommitPublished, channelKeys: ChannelKeys, commitment: FullCommitment, feerates: OnChainFeerates): LocalCommitThirdStageTransactions {
                val confirmedHtlcTxs = localCommitPublished.htlcOutputs.mapNotNull { htlcOutput -> localCommitPublished.irrevocablySpent.get(htlcOutput) }
        ...
        object RevokedClose {
            ...
            fun LoggingContext.claimCommitTxOutputs(
                ...
                logger.warning { "a revoked commit has been published with commitmentNumber=$commitmentNumber" }
