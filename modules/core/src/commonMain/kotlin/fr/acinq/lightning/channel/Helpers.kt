    ...
    object Funding {
        ...
        fun makeFundingInputInfo(
            ...
            return if (isTaprootChannel) {
                ...
                Transactions.InputInfo.TaprootInput(OutPoint(fundingTxId, fundingTxOutputIndex.toLong()), fundingTxOut, musig2Aggregate(fundingPubkey1, fundingPubkey2), null)
            } else {
