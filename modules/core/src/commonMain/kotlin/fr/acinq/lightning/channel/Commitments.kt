...
sealed class LocalFundingStatus {
    ...
    data class ConfirmedFundingTx(override val txId: TxId, override val txOut: TxOut, override val fee: Satoshi, val localSigs: TxSignatures, val shortChannelId: ShortChannelId) : LocalFundingStatus() {
