...
data class AddHtlcFailed                       (override val channelId: ByteVector32, val paymentHash: ByteVector32, val t: Throwable, val paymentId: UUID, val channelUpdate: ChannelUpdate?, val originalCommand: CMD_ADD_HTLC?) : ChannelException(channelId, "cannot add htlc with paymentId=$paymentId reason=${t.message}")
