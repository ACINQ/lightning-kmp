                    ...
                    when {
                        ...
                        payment.amountReceived < payment.totalAmount -> {
                            ...
                            if (payment.parts.filterIsInstance<PayToOpenPart>().isNotEmpty()) {
                                ...
                                nodeParams.liquidityPolicy.value.maybeReject(payment.amountReceived, payToOpenFee.toMilliSatoshi(), LiquidityEvents.Source.OffChainPayment(paymentPart.paymentHash), logger)?.let { rejected ->
