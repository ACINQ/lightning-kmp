...
object Scripts {
    ...
    object Taproot {
        ...
        val anchorScriptTree = ScriptTree.Leaf(0, anchorScript)
        ...
        fun toLocalKey(revocationPubkey: PublicKey, toSelfDelay: CltvExpiryDelta, localDelayedPaymentPubkey: PublicKey): Pair<XonlyPublicKey, Boolean> {
            ...
            val scriptTree = ScriptTree.Branch(
                ScriptTree.Leaf(0, delayScript),
                ScriptTree.Leaf(1, revokeScript),
            )
        ...
        fun toLocalScriptTree(revocationPubkey: PublicKey, toSelfDelay: CltvExpiryDelta, localDelayedPaymentPubkey: PublicKey): ScriptTree.Branch {
            return ScriptTree.Branch(
                ScriptTree.Leaf(0, toDelayScript(localDelayedPaymentPubkey, toSelfDelay)),
                ScriptTree.Leaf(1, toRevokeScript(revocationPubkey, localDelayedPaymentPubkey)),
            )
        }
        ...
        fun toRemoteKey(remotePaymentPubkey: PublicKey): Pair<XonlyPublicKey, Boolean> {
            ...
            val scriptTree = ScriptTree.Leaf(0, remoteScript)
         ...
         */
        fun toRemoteScriptTree(remotePaymentPubkey: PublicKey) = ScriptTree.Leaf(0, toRemoteScript(remotePaymentPubkey))
        ...
        fun offeredHtlcTree(localHtlcPubkey: PublicKey, remoteHtlcPubkey: PublicKey, paymentHash: ByteVector32) =
            ScriptTree.Branch(
                ScriptTree.Leaf(0, offeredHtlcTimeoutScript(localHtlcPubkey, remoteHtlcPubkey)),
                ScriptTree.Leaf(1, offeredHtlcSuccessScript(remoteHtlcPubkey, paymentHash))
            )
        ...
        fun receivedHtlcTree(localHtlcPubkey: PublicKey, remoteHtlcPubkey: PublicKey, paymentHash: ByteVector32, lockTime: CltvExpiry): ScriptTree.Branch {
            return ScriptTree.Branch(
                ScriptTree.Leaf(0, receivedHtlcTimeoutScript(remoteHtlcPubkey, lockTime)),
                ScriptTree.Leaf(1, receivedHtlcSuccessScript(localHtlcPubkey, remoteHtlcPubkey, paymentHash)),
            )
        }
    }
}