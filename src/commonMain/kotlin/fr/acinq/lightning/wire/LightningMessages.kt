...
data class SpliceInit(
    ...
    constructor(
        ...
        nextLocalNonces: List<IndividualNonce> = listOf()
    ) : this(
        channelId,
        fundingContribution,
        feerate,
...
data class SpliceAck(
    ...
    constructor(channelId: ByteVector32, fundingContribution: Satoshi, pushAmount: MilliSatoshi, fundingPubkey: PublicKey, willFund: ChannelTlv.WillFund?, nextLocalNonces: List<IndividualNonce> = listOf()) : this(
        channelId,
        fundingContribution,
        fundingPubkey,
        TlvStream(
