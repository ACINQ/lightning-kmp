...
class NoiseTestsJvm : EclairTestSuite() {
    ...
    fun `SymmetricState test`() {
        ...
        assertArrayEquals(symmetricState1.ck, Hex.decode("4e6f6973655f4e4e5f32353531395f436861436861506f6c795f534841323536"))
        assertArrayEquals(symmetricState1.h, Hex.decode("03b71896d90661cfed747aaaca293d1b01365b3f0f6605dbc3c85a7eb9fff519"))
    }
...
//        val key2 = Hex.decode("2122232425262728292a2b2c2d2e2f303132333435363738393a3b3c3d3e3f40")
    ...
    fun `Noise_NN_25519_ChaChaPoly_SHA256 cacophony test`() {
        ...
        */
        ...
        val (enc, dec) = foo
        assertArrayEquals(outputs[0], Hex.decode("ca35def5ae56cec33dc2036731ab14896bc4c75dbb07a61f879f8e3afa4c79444c756477696720766f6e204d69736573"))
        assertArrayEquals(outputs[1], Hex.decode("95ebc60d2b1fa672c1f46a8aa265ef51bfe38e7ccb39ec5be34069f144808843a0ff96bdf86b579ef7dbf94e812a7470b903c20a85a87e3a1fe863264ae547"))
...
//        val key2 = Hex.decode("2122232425262728292a2b2c2d2e2f303132333435363738393a3b3c3d3e3f40")
        ...
        assertArrayEquals(outputs[0], Hex.decode("358072d6365880d1aeea329adf9121383851ed21a28e3b75e965d0d2cd1662549963aa4003cb0f60f51f7f8b1c0e6a9c"))
