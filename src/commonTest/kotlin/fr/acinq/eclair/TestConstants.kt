...
object TestConstants {
    ...
    val Alice: Person = run {
        ...
        Person(seed, keyManager, nodeParams, channelParams)
    }
    ...
    val Carol: Person = run {
        val seed = ByteVector32("0303030303030303030303030303030303030303030303030303030303030303")
        val keyManager = LocalKeyManager(Alice.seed, Block.RegtestGenesisBlock.hash)
        val nodeParams = NodeParams(
            keyManager = keyManager,
            alias = "carol",
