...
object TestsHelper {
    ...
    fun mutualCloseAlice(alice: LNChannel<Normal>, bob: LNChannel<Normal>, scriptPubKey: ByteVector? = null, closingFeerate: FeeratePerKw? = null): Triple<LNChannel<Negotiating>, LNChannel<Negotiating>, Transaction> {
    ...
    fun mutualCloseBob(alice: LNChannel<Normal>, bob: LNChannel<Normal>, scriptPubKey: ByteVector? = null, closingFeerate: FeeratePerKw? = null): Triple<LNChannel<Negotiating>, LNChannel<Negotiating>, Transaction> {
        ...
        val shutdownAlice = actionsAlice1.findOutgoingMessage<Shutdown>()
        actionsAlice1.findOutgoingMessage<ClosingComplete>()
