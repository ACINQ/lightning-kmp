...
class WaitForFundingConfirmedTestsCommon : LightningTestSuite() {
    ...
    companion object {
        ...
        fun init(
            ...
            assertIs<WaitForFundingConfirmed>(alice1.state)
            assertIs<LNChannel<WaitForFundingConfirmed>>(alice1) // for compiler: only tests LNChannel<Any>
            ...
            assertIs<WaitForFundingConfirmed>(bob1.state)
            assertIs<LNChannel<WaitForFundingConfirmed>>(bob1) // for compiler: only tests LNChannel<Any>
        ...
        fun rbf(alice: LNChannel<WaitForFundingConfirmed>, bob: LNChannel<WaitForFundingConfirmed>, txSigsBob: TxSignatures, walletAlice: WalletState): Pair<LNChannel<WaitForFundingConfirmed>, LNChannel<WaitForFundingConfirmed>> {
            ...
            assertIs<WaitForFundingConfirmed>(alice0.state)
            ...
            assertIs<LNChannel<WaitForFundingConfirmed>>(alice2) // for compiler: only tests LNChannel<Any>
            ...
            assertIs<WaitForFundingConfirmed>(alice3.state)
        ...
        private fun completeInteractiveTxRbf(alice: LNChannel<WaitForFundingConfirmed>, bob: LNChannel<WaitForFundingConfirmed>, messageAlice: InteractiveTxMessage): Pair<LNChannel<WaitForFundingConfirmed>, LNChannel<WaitForFundingConfirmed>> {
            ...
            return when (val txComplete = actionsAlice1.findOutgoingMessageOpt<TxComplete>()) {
                null -> {
                    ...
                    assertIs<WaitForFundingConfirmed>(bob3.state)
                    assertIs<LNChannel<WaitForFundingConfirmed>>(bob3) // for compiler: only tests LNChannel<Any>
                    ...
                    assertIs<WaitForFundingConfirmed>(alice3.state)
                    assertIs<LNChannel<WaitForFundingConfirmed>>(alice3) // for compiler: only tests LNChannel<Any>
