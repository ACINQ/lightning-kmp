...
class ClosingTestsCommon : LightningTestSuite() {
    ...
    fun `recv BITCOIN_FUNDING_SPENT -- mutual close before converging`() {
        ...
        assertContains(bobActions5, ChannelAction.Storage.SetConfirmationStatus(mutualCloseTx.tx.txid, ChannelAction.Storage.SetConfirmationStatus.ConfirmationStatus.LOCKED))
    }
    ...
    fun `recv BITCOIN_TX_CONFIRMED -- mutual close`() {
        ...
        assertContains(actions1, ChannelAction.Storage.SetConfirmationStatus(mutualCloseTx.tx.txid, ChannelAction.Storage.SetConfirmationStatus.ConfirmationStatus.LOCKED))
    }
    ...
    fun `recv BITCOIN_TX_CONFIRMED -- mutual close with external btc address`() {
        ...
        assertIs<LNChannel<Closed>>(bob4)
        assertContains(bobActions4, ChannelAction.Storage.SetConfirmationStatus(mutualCloseTx.tx.txid, ChannelAction.Storage.SetConfirmationStatus.ConfirmationStatus.LOCKED))
    }
    ...
    fun `recv BITCOIN_TX_CONFIRMED -- local commit`() {
        ...
        assertContains(actions, ChannelAction.Storage.SetConfirmationStatus(localCommitPublished.commitTx.txid, ChannelAction.Storage.SetConfirmationStatus.ConfirmationStatus.LOCKED))
    }
    ...
    fun `recv BITCOIN_TX_CONFIRMED -- remote commit`() {
        ...
        assertContains(actions, ChannelAction.Storage.SetConfirmationStatus(remoteCommitPublished.commitTx.txid, ChannelAction.Storage.SetConfirmationStatus.ConfirmationStatus.LOCKED))
    ...
    fun `recv BITCOIN_TX_CONFIRMED -- future remote commit`() {
        ...
        assertContains(aliceActions5, ChannelAction.Storage.SetConfirmationStatus(bobCommitTx.txid, ChannelAction.Storage.SetConfirmationStatus.ConfirmationStatus.LOCKED))
    }
    ...
    companion object {
        ...
        private fun confirmWatchedTxs(firstClosingState: LNChannel<Closing>, watchConfirmed: List<WatchEventConfirmed>) {
            ...
            actions.find<ChannelAction.Storage.SetConfirmationStatus>().also { assertEquals(ChannelAction.Storage.SetConfirmationStatus.ConfirmationStatus.LOCKED, it.status) }
        }
    }
