...
class ChannelFeaturesTestsCommon : LightningTestSuite() {
    ...
    fun `channel type uses mandatory features`() {
        ...
        assertEquals(ChannelType.SupportedChannelType.AnchorOutputsZeroReserve.toFeatures(), Features(Feature.Wumbo to FeatureSupport.Mandatory, Feature.ZeroReserveChannels to FeatureSupport.Mandatory, Feature.StaticRemoteKey to FeatureSupport.Mandatory, Feature.AnchorOutputs to FeatureSupport.Mandatory))
        assertEquals(ChannelType.SupportedChannelType.AnchorOutputsZeroConfZeroReserve.toFeatures(), Features(Feature.Wumbo to FeatureSupport.Mandatory, Feature.ZeroConfChannels to FeatureSupport.Mandatory, Feature.ZeroReserveChannels to FeatureSupport.Mandatory, Feature.StaticRemoteKey to FeatureSupport.Mandatory, Feature.AnchorOutputs to FeatureSupport.Mandatory))
        // @formatter:on
    }
    ...
    fun `extract channel type from channel features`() {
        ...
        assertEquals(ChannelType.SupportedChannelType.AnchorOutputsZeroConfZeroReserve, ChannelFeatures(setOf(Feature.StaticRemoteKey, Feature.AnchorOutputs, Feature.Wumbo, Feature.ZeroConfChannels, Feature.ZeroReserveChannels)).channelType)
        // @formatter:on
    }
    ...
    fun `extract channel type from features`() {
        ...
        assertEquals(ChannelType.SupportedChannelType.AnchorOutputsZeroReserve, ChannelType.fromFeatures(Features(Feature.Wumbo to FeatureSupport.Mandatory, Feature.ZeroReserveChannels to FeatureSupport.Mandatory, Feature.StaticRemoteKey to FeatureSupport.Mandatory, Feature.AnchorOutputs to FeatureSupport.Mandatory)))
