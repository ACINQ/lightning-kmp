...
class OfferManagerTestsCommon : LightningTestSuite() {
    ...
    fun `pay offer through the same trampoline node`() = runSuspendTest {
        ...
        assertEquals(Either.Right(EncodedNodeId.PhoenixId(TestConstants.Alice.nodeParams.nodeId)), nextNodeAlice)
        ...
        assertEquals(Either.Right(EncodedNodeId.PhoenixId(TestConstants.Bob.nodeParams.nodeId)), nextNodeBob)
