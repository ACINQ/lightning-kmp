...
class PaymentRequestTestsCommon : LightningTestSuite() {
    ...
    fun `Now send $24 for an entire list of things (hashed)`() {
        ...
        assertEquals(
            pr.descriptionHash,
            Crypto.sha256("One piece of chocolate cake, one icecream cone, one pickle, one slice of swiss cheese, one slice of salami, one lollypop, one piece of cherry pie, one sausage, one cupcake, and one slice of watermelon".encodeToByteArray())
                .toByteVector32()
        )
        assertNull(pr.fallbackAddress)
        assertEquals(pr.tags.size, 2)
    ...
    fun `payment secret`() {
        ...
        val pr2 =
            PaymentRequest.read("lnbc40n1pw9qjvwpp5qq3w2ln6krepcslqszkrsfzwy49y0407hvks30ec6pu9s07jur3sdpstfshq5n9v9jzucm0d5s8vmm5v5s8qmmnwssyj3p6yqenwdencqzysxqrrss7ju0s4dwx6w8a95a9p2xc5vudl09gjl0w2n02sjrvffde632nxwh2l4w35nqepj4j5njhh4z65wyfc724yj6dn9wajvajfn5j7em6wsq2elakl")
