...
class LiquidityAdsTestsCommon : LightningTestSuite() {
    ...
    fun `validate liquidity ads funding attempt`() {
        ...
        val willFund = fundingRates.validateRequest(nodeKey, fundingScript, FeeratePerKw(1000.sat), request, 0.msat)?.willFund
        ...
        testCases.forEach {
            val result = request.validateRemoteFunding(nodeKey.publicKey(), channelId, fundingScript, it.remoteFundingAmount, FeeratePerKw(2500.sat), 0.msat, it.willFund)
