        ...
        run {
            ...
            val htlcPenaltyTx = when (isTaprootChannel) {
                true -> {
                    ...
                    makeHtlcPenaltyTx(commitTx.tx, htlcOutputIndex, Transactions.ScriptTreeAndInternalKey(scriptTree, localRevocationPriv.publicKey().xOnly()), localDustLimit, finalPubKeyScript.byteVector(), feerate)
                }
